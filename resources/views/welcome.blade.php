...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="{{ route('home') }}">Drive<span>wise</span></a></h1>
  ...
  @endauth
      ...
      <form action="{{ route('logout') }}" method="POST">
        @csrf
          <button class="get-started-btn  scrollto">LOGOUT</button>
      </form>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1>Where Every Mile Begins a New Journey<span>.</span></h1>
          <h2>We're digital experts turbocharging car stores</h2>
        </div>
      </div>
  ...
  <main id="main">
    ...
    <section id="team" class="team">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Delears</h2>
          <p>Top Performing Dealers</p>
        </div>

        <div class="row">

        @foreach($topDealerSales as $topDealerSale)

          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="member-img">
              <img width="100%" src="{{ asset('storage/carscontainer/' . $topDealerSale->image) }}" alt="" class="img-a img-fluid" />
                <div class="social">
              ...
              <div class="member-info">
                <h4>{{$topDealerSale->name}}</h4>
                <span>{{$topDealerSale->email}}</span>
              </div>
            </div>
          </div>
